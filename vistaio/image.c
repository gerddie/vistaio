...
VistaIODictEntry VistaIOBandInterpDict[] = {
	{"complex", VistaIOBandInterpComplex, NULL, 0, 0, 0.0}
	,
	{"gradient", VistaIOBandInterpGradient, NULL, 0, 0, 0.0}
	,
	{"intensity", VistaIOBandInterpIntensity, NULL, 0, 0, 0.0}
	,
	{"orientation", VistaIOBandInterpOrientation, NULL, 0, 0, 0.0}
	,
	{"rgb", VistaIOBandInterpRGB, NULL, 0, 0, 0.0}
	,
	{"stereo_pair", VistaIOBandInterpStereoPair, NULL, 0, 0, 0.0}
	,
	{NULL, 0, NULL, 0, 0, 0.0}
};
